...
Typed external definitions are registered only at bootstrap. Do not generate catalogs from remote
or untrusted configuration. Definition names, field keys, allowed values, conditional rules, resource
values, and series bounds are security/privacy policy and require code review.
