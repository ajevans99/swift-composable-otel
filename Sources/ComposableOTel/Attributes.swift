...
public enum TCAAttributes {
  ...
  public static let effectDurationMs = "tca.effect.duration_ms"
  ...
  public static let dependencyOutcome = "tca.dependency.outcome"
  public static let dependencyCancelled = "tca.dependency.cancelled"
  public static let dependencyDurationMs = "tca.dependency.duration_ms"
  public static let flowRoot = "tca.flow.root"
